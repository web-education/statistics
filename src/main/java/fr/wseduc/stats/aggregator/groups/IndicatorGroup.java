package fr.wseduc.stats.aggregator.groups;
...
public class IndicatorGroup {
	...
	private HashSet<IndicatorGroup> childGroups = new HashSet<IndicatorGroup>();
	 ...
	 */
	public IndicatorGroup addGroup(String group){
	 ...
	 * @return The current group.
	 */
	public IndicatorGroup addGroup(IndicatorGroup group){
