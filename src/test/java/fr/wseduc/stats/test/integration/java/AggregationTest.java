...
//				.put("address", MONGO_PERSISTOR)
//				.put("host", "localhost").put("port", 27017)
//				.put("db_name", "one_stats_integration_tests")
//				.put("pool-size", 10);
//
//		container.deployModule("io.vertx~mod-mongo-persistor~2.0.2-final-WSE", mongoConfig, 1, new Handler<AsyncResult><String>(){
...
//		if(!row.containsKey(STATS_FIELD_GROUPBY)){
...
//							JsonArray results = message.body().getJsonArray("results", new JsonArray());
//
